...
| ----------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Foundation Building**                      | ~2027/05 | AI/IoT/math learning + home test field / 10㎡ organic garden + records / Blog/X posts + tagging / Sustainable life & mental                  |
| **2. Practice & Partnership**                   | ~2029/05 | Local IoT/Edge-AI prototype operation + visualization / OSS/study group team building / Full-scale farmhouse/farm operation                  |
| **3. Solution Establishment**                   | ~2031/05 | Lightweight math model + serverless OSS (Aoya Model v1) / Integrated data dashboard / Video courses + forum community                        |
| **4. Full-Scale Contribution & Independence**   | ~2033/05 | Multi-farm/municipality deployment + proven effects / Business & financial stability (support + subscription/grants) / Local leader training |
| **5. Influence Expansion & Vision Realization** | ~2035/05 | Model dissemination in/outside Japan / Policy proposals/standardization / Handover of operations + new tech/research                         |
